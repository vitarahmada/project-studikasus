    ...
    <section class="service_section layout_padding ">
        <div class="container">
            ...
            <div class="row">
                ...
                $novel = mysqli_query($connection, "SELECT * FROM novel JOIN penulis ON novel.id_penulis = penulis.id_penulis JOIN kategori ON novel.id_kategori = kategori.id_kategori");
                    ...
                    <div class="col-md-4">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p style="font-weight: bold; font-size:small">
                                    Kategori : <?php echo $novel1["nama_kategori"]; ?>
                                </p>
                                <p>
                                    <?php
                                    echo substr($novel1["ket"], 0, 100) . "...";
                                    ?>
                                </p>
