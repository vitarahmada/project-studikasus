    ...
    <section class="service_section layout_padding ">
        <div class="container">
            ...
            <div class="row">
                ...
                foreach ($penulis as $key => $penulis1) {
                ?>
                    <div class="col-md-4">
                        <div class="box ">
                            <div class="img-box">
                            ...
                            <div class="detail-box">
                                <h6>
                                    <?php echo $penulis1["nama_penulis"]; ?>
                                </h6>
                                <!--  -->
                                <div class="row">
                                    <div class="col">
                                        <a href="edit_penulis.php?id_penulis=<?php echo $penulis1["id_penulis"] ?>" class="btn">Edit</a>
                                    </div>
                                    <div class="col">
                                        <a href="back-end/proses_delete_penulis.php?id_penulis=<?php echo $penulis1["id_penulis"] ?>" class="btn" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
