    ...
    <section class="service_section layout_padding ">
        <div class="container">
            ...
            <div class="row">
                ...
                $novel = mysqli_query($connection, "SELECT * FROM novel JOIN penulis ON novel.id_penulis = penulis.id_penulis JOIN kategori ON novel.id_kategori = kategori.id_kategori WHERE novel.id_kategori = 2");
