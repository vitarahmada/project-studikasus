...
<body class="sub_page">
    ...
    <section class="service_section layout_padding ">
        <div class="container">
            ...
            <form class="text-light" action="back-end/proses_add_novel.php" method="post">
                <div class="form-group">
                    <label>ID Kategori</label>
                    <select class="form-control"  name="id_kategori">
                        <?php foreach ($kategori1 as $kategori) { ?>
                        <option><?php echo $kategori['id_kategori'] . " - " . $kategori['nama_kategori'] ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control"  name="id_penulis">
                        <?php foreach ($penulis1 as $penulis) { ?>
                            <option><?php echo $penulis['id_penulis'] . " - " . $penulis['nama_penulis'] ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleFormControlInput2" name="harga">
                </div>
